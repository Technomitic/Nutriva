...
const s = StyleSheet.create({
  ...
  slotCard: {
    ...
    borderWidth: 1.5, borderColor: 'rgba(46, 125, 50, 0.15)', marginBottom: spacing.sm,
  },
  slotCardActive: { borderColor: 'rgba(46, 125, 50, 0.22)', backgroundColor: '#2E7D32' },
  slotIcon: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(46, 125, 50, 0.15)', alignItems: 'center', justifyContent: 'center' },
